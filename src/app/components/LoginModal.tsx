...
export default function LoginModal({ open, onClose }: LoginModalProps) {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    if (error) {
      ...
      onClose()
      // ✅ After a successful password login, land on the student dashboard
  ...
  return (
    <Modal open={open} onClose={onClose}>
      <div className="space-y-4">
        ...
        {/* ------------------------------------------------------------
             Google OAuth button – include redirectTo so Supabase
             returns directly to /student-dashboard (works for both
